...
public class ProductDto implements org.apache.thrift.TBase<ProductDto, ProductDto._Fields>, java.io.Serializable, Cloneable, Comparable<ProductDto> {
  ...
  public @org.apache.thrift.annotation.Nullable String externalId; // required
  ...
  public @org.apache.thrift.annotation.Nullable String agreementId; // required
  ...
  public ProductDto setExternalId(@org.apache.thrift.annotation.Nullable String externalId) {
    this.externalId = externalId;
    return this;
  }
  ...
  public ProductDto setName(@org.apache.thrift.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ProductDto setAgreementId(@org.apache.thrift.annotation.Nullable String agreementId) {
    this.agreementId = agreementId;
    return this;
  }
  ...
  public int compareTo(ProductDto other) {
    ...
    lastComparison = Boolean.valueOf(isSetAgreementId()).compareTo(other.isSetAgreementId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAgreementId()) {
